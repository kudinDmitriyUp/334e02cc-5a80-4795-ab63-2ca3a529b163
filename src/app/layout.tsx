...
export const metadata: Metadata = {
  title: "Silly Bands Store - Buy Colorful Rubber Bands Online",
  description: "Shop premium silly bands, rare designs, and exclusive collections. Free shipping, 30-day guarantee, and authentic quality. Start your collection today!",
  keywords: "silly bands, rubber bands, collectible toys, bracelet bands, online store",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Silly Bands Store - Ultimate Collection",
    description: "Discover amazing silly bands with 500+ unique designs. Fast shipping and collector bundles available.",
    type: "website",
    siteName: "Silly Bands Store"
  },
  twitter: {
    card: "summary_large_image",
    title: "Silly Bands Store",
    description: "Your destination for premium silly bands and exclusive designs"
  }
};
